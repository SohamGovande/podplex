...
export default function Home() {
  ...
  const [listAllPods, { data: allPodsData, loading: allPodsLoading }] = useLazyQuery(GET_ALL_PODS, {
    pollInterval: 5000,
  })
  ...
  return (
    <div className='p-24 flex flex-col gap-y-8 w-full'>
      <div className='flex justify-between items-center w-full'>
        <p className='text-2xl'>View Training State</p>
        <Button className='flex gap-x-4' onClick={listPods} disabled={allPodsLoading}>
          Refresh
          <IoRefresh size={16} />
        </Button>
      </div>
...
function NoPods() {
  return (
    <div className='mx-auto max-w-md space-y-4 text-center min-h-[50vh] flex flex-col items-center justify-center'>
      ...
      <h2 className='text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-50'>No Active Pods</h2>
      <p className='text-gray-500 dark:text-gray-400'>
        You don&apos;t have any active pods yet. Pods will automatically be started when you start training a model.
      </p>
      <Link href='/train'>
