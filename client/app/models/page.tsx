      ...
      <div className='mx-auto max-w-6xl'>
        <div className='mb-8'>
          <div className='flex justify-between'>
            <h1 className='text-3xl font-bold tracking-tight md:text-4xl'>Trained Models</h1>
            <Link href='/train'>
          ...
          <p className='mt-2 text-gray-500 dark:text-gray-400 font-inter'>View details and metrics for the language models you&apos;ve trained.</p>
        </div>
        <div className='overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800'>
          <table className='w-full table-auto'>
            <thead className='bg-gray-100 dark:bg-gray-800'>
              <tr>
                <th className='px-6 py-4 text-left font-medium text-gray-900 dark:text-gray-50 font-inter'>Model Name</th>
                <th className='px-6 py-4 text-left font-medium text-gray-900 dark:text-gray-50 font-inter'>Metrics</th>
            ...
            <tbody className='divide-y divide-gray-200 dark:divide-gray-800'>
              {models.map(model => (
                <tr key={model.name}>
                  <td className='px-6 py-4 font-medium text-gray-900 dark:text-gray-50 font-inter'>{model.name}</td>
                  <td className='px-6 py-4 text-gray-500 dark:text-gray-400 font-inter'>{model.metrics}</td>
